...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in 0..10) {
            if (i == 2 || i == 4) {
                list.add(TextBean("我是短文字，不足三行", false))
            } else {
                list.add(TextBean("\t\t\t\t\t医患关系，是影响护士职业幸福感的第一大因素。护理部主任万长秀坦言，护士是医疗服务的终端，病人对所有医疗环节的不满，最终发泄口都是护士。去年《中国护士群体发展现状调查报告》显示：41.2%的护士在近一年内，遭受过患者或家属的过激行为；在各种职业伤害类型中，他们的心理创伤比例最高。" +
